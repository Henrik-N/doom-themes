;;; doom-gruvboxy-theme.el --- Custom gruvboxy -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;;; Commentary:
;;; Code:
...
(defcustom doom-gruvboxy-dark-variant nil
  "A choice of \"hard\" or \"soft\" can be used to change the background contrast. All other values default to \"medium\"."
  :group 'doom-gruvbox-theme
  :type  'string)
...
(def-doom-theme doom-gruvboxy
  ...
  ((bg
   ...
   ;; other colors
   (aqua dark-cyan)
   (purple      '("#d3869b", "#d3869b", "purple"))      ; purple
